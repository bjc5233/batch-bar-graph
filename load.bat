...
:_strlen2
::¼ÆËã×Ö·û´®µÄ×Ö½ÚÊı
::×¢Òâ:´´½¨µÄÁÙÊ±ÎÄ¼şÓ¦¸Ã¾ßÓĞÎ¨Ò»ĞÔ[Ê±¼äĞÅÏ¢], ·ñÔòÁ½¸öbatÎÄ¼şÍ¬Ê±Ê¹ÓÃ¸Ãº¯Êı»áµ¼ÖÂ×Ö½ÚÊı¼ÆËã´íÎó
::IN[×Ö·û´®±äÁ¿Ãû]    OUT[len]
set "_strlen2=do setlocal enabledelayedexpansion& set _timeStr=%time::=%& (>%temp%\_strlen2_!_timeStr!.tmp echo.!%%1!)& for %%i in (%temp%\_strlen2_!_timeStr!.tmp) do endlocal& set /a %%2=%%~zi-2& del /q %%~i" & goto :EOF
...
:_getThemeColor
::»ñÈ¡µ±Ç°Ö÷ÌâÑÕÉ« ÑÕÉ«Ä¿Ç°²»ÊÇÊµÊ±Ë¢ĞÂµÄ[²»½¨ÒéÊ¹ÓÃ]
::OUT[µ±Ç°Ö÷ÌâÑÕÉ«]
